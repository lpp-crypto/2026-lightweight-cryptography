...
#+SUBTITLE: /How do cryptographic primitives go from idea to deployment?/
#+AUTHOR: Léo Perrin
...
#+LATEX_HEADER_EXTRA: \RequirePackage{sectsty} \allsectionsfont{\sffamily\boldmath} \renewcommand*\descriptionlabel[1]{\hspace\labelsep \normalfont\bfseries\sffamily\boldmath #1}
#+cite_export: bibtex alpha 
#+BIBLIOGRAPHY: ./biblio.bib


* What Primitives are Deployed?
** Where is cryptography deployed "in real life"?
...
** How can a primitive deserve trust?
...
I wasn't just in the front row to watch this "competition" unfold, I was somewhere on the stage! How did it go? Let's see this through the history of SPARKLE [cite:@sparkle], a candidate I co-designed. Some of this The timeline can be also be seen on the NIST website for this process:
...
- October 2016 :: NIST organized a first workshop on their campus[fn:8]. I presented a block cipher I co-designed, SPARX [cite:@sparx]; the NSA presented SIMON and SPECK [cite:@simon].
- March 2017 :: NIST publishes a report[fn:9] stating their intention to move forward with standardization.
...
- Late 2018 :: NIST published a call for submissions[fn:10] on a mailing list that had been setup a bit earlier[fn:11]. However, the original timeline is messed up by an American government shutdown.
...
- June 2020 :: The academic community publishes a special issue of the ToSC journal[fn:12] which gave an opportunity for Round 2 candidates to properly present their submission to the academic community.
...
- Februry 2023 :: ASCON is announced as the winner of the competition.
...
[fn:8] [[https://csrc.nist.gov/Events/2016/lightweight-cryptography-workshop-2016]]

[fn:9] [[https://nvlpubs.nist.gov/nistpubs/ir/2017/NIST.IR.8114.pdf]]
[fn:10] [[https://csrc.nist.gov/csrc/media/Projects/lightweight-cryptography/documents/final-lwc-submission-requirements-august2018.pdf]]

[fn:11] [[https://csrc.nist.gov/projects/lightweight-cryptography/email-list]]

[fn:12] [[https://tosc.iacr.org/index.php/ToSC/issue/view/182]]
