...
The folder [./PIPO-cipher/](PIPO-cipher) contains the specification of a new family of 128-bit block ciphers that Borduria is pushing to have standardized. The specification is a simple pdf file called [./PIPO-cipher/spec.pdf](spec.pdf), and its authors have provided a reference implementation in Python in the file [./PIPO-cipher/reference.py](reference.py). This proves their good faith, right?
